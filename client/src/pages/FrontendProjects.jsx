...
export default function FrontendProjects() {
  return <ProjectsPage category="frontend" title="Frontend Projects" subtitle="UI-focused projects built with modern frontend technologies" seoPath="/frontend-projects" />;
}

export function FullStackProjectsPage() {
  return <ProjectsPage category="fullstack" title="Full Stack Projects" subtitle="Complete web applications with frontend and backend" seoPath="/fullstack-projects" />;
}
...
function ProjectsPage({ category, title, subtitle, seoPath }) {
  ...
  return (
    <PageTransition>
      <SEO title={title} description={subtitle} path={seoPath} />
            ...
            {selected && (
              ...
              >
                ...
                >
                  ...
                  {selected.image && (
                    <img src={selected.image} alt={selected.title} className="w-full h-56 object-cover rounded-xl mb-4" />
                  )}
