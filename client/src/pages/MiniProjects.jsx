...
export default function MiniProjects() {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    api.get('/projects', { params: { category: 'mini', search, sort, page, limit: 9 } })
      .then((r) => {
  ...
  return (
    <PageTransition>
      <SEO title="Mini Projects" description="Small projects demonstrating core programming concepts and quick solutions" path="/mini-projects" />
      <section className="min-h-screen py-24 sm:py-32 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <SectionTitle title="Mini Projects" subtitle="Quick projects demonstrating core concepts" />
